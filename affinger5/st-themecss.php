...
input#searchsubmit {
	<?php if ( $st_search_form_padding_lr ): ?>
		padding-right: calc( 50px + <?php echo $st_search_form_padding_lr; ?>px);
		padding-left: <?php echo $st_search_form_padding_lr; ?>px;
	<?php endif; ?>
	<?php if ( $st_search_form_padding_tb ): ?>
		padding-top: calc( 50px + <?php echo $st_search_form_padding_tb; ?>px);
		padding-bottom: calc( 50px + <?php echo $st_search_form_padding_tb; ?>px);
	<?php endif; ?>
	<?php if ( $st_search_form_icon_color ): ?>
		color: <?php echo $st_search_form_icon_color; ?>;
	<?php endif; ?>
	<?php if ( $st_search_form_border_radius ): ?>
		border-radius: 0 <?php echo $st_search_form_border_radius; ?>px  <?php echo $st_search_form_border_radius; ?>px 0;
	<?php endif; ?>
	<?php if ( $st_search_form_font_size ): ?>
		font-size: <?php echo $st_search_form_font_size; ?>px;
	<?php endif; ?>
...
<?php if( trim($GLOBALS['stdata488']) !== ''): //サムネイル画像を角丸に変更する ?>
...
<?php if ( isset($GLOBALS['stdata375']) && $GLOBALS['stdata375'] === 'yes' ): // LPワイドの左右にシャドウ -EX ?>
	...
	<?php if ( ( trim(  $GLOBALS['stdata366'] ) === '' ) &&  $st_h3_design_wide ): ?>
		...
		@media only screen and (max-width: 959px) {
			...
			.colum1.st-lp-wide .entry-content h3:not(.st-css-no):not(.st-matome):not(.rankh3):not(.post-card-title):not(#reply-title)
			{
				margin-left: -20px;
				margin-right: -20px;
				<?php if ( ($st_h3_designsetting !== 'dotdesign') && ($st_h3_designsetting !== 'linedesign') ): //ドットデザイン及びセンターラインデザインではない場合 ?>

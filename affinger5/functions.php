...
if ( !function_exists( 'st_marumozi' ) ) {
	function st_marumozi( $atts, $content = null ) {
		...
		return '<span class="st-marumozi" style="' . esc_attr( $bgcolor_css . $color_css . $radius_css . $margin_css . $bordercolor_css ) . '">' . $fontawesome_html . $content . '</span>';
	}
}
...
if ( !function_exists( 'st_marumozi_big' ) ) {
	function st_marumozi_big( $atts, $content = null ) {
		...
		return '<p class="st-marumozi-big-p"><span class="st-marumozi-big" style="' . esc_attr( $bgcolor_css . $color_css . $radius_css . $margin_css . $bordercolor_css ) . '">' . $fontawesome_html . $content . '</span></p>';
	}
}

...
function authorinfoFunc( $atts, $content = null ) {
    ...
    return '<div class="detail-author-box flexbox--v-center"><div class="detail-author-box__img"><img src="' . $img . '"/></div><div class="detail-author-box__txt"><div class="detail-author-box__title">' . $author_name . '</div><div class="detail-author-box__read">' . $read . '</div><div class="detail-author-box__sns flexbox"><div class="author-box__btn" target="_blank"><a href="' . $weblink . '" target="_blank"><div class="author-box__btn web__btn__small" target="_blank"><i class="fas fa-link"></i></div></a></div>　<div class="author-box__btn" target="_blank"><a href="' . $facebooklink . '" target="_blank"><div class="author-box__btn facebook__btn__small "target="_blank"><i class="fab fa-facebook-f"></i></div></a></div><div class="author-box__btn" target="_blank"><a href="' . $twitterlink . '" target="_blank"><div class="author-box__btn twitter__btn__small" target="_blank"><i class="fab fa-twitter"></i></div></a></div></div></div></div>';
}

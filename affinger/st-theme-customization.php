...
if ( !function_exists( 'st_get_plain_theme_mod_defaults' ) ) {
	function st_get_plain_theme_mod_defaults() {
		return array(
			...
			'st_menu_smartbar_bg_image_cover'      => '',
...
if ( !function_exists( 'st_get_var_theme_mod_maps' ) ) {
	function st_get_var_theme_mod_maps() {
		return array(		
			...
			'st_body_sub_bgcolor'  		    => 'st_body_sub_bgcolor',
			'st_body_bg_designsetting'  	=> 'st_body_bg_designsetting',
			...
			'st_headerarea_bgcolor'        => 'st_headerarea_bgcolor',
			...
			'st_main_setting_exclude_front'     => 'st_main_setting_exclude_front',
			...
			'st_kuzu_b'          => 'st_kuzu_b',
			'st_kuzu_b_color'    => 'st_kuzu_b_color',
			'st_kuzu_b_bg_color' => 'st_kuzu_b_bg_color',
			...
			'st_entrytitle_bgimg_margin'      => 'st_entrytitle_bgimg_margin',
			...
			'st_header_top_stripe'       => 'st_header_top_stripe',
			...
			'st_menu_smartbar_bg_image_cover'      => 'st_menu_smartbar_bg_image_cover',
...
function st_customize_register( $wp_customize ) {
	...
	if ( st_is_customizer_enabled() ) {
		...
		/* TOP除外 */
		$wp_customize->add_setting( 'st_main_setting_exclude_front',
			array(
				'default'           => $defaults['st_main_setting_exclude_front'],
				'sanitize_callback' => 'sanitize_checkbox',
			) );
		$wp_customize->add_control( 'st_main_setting_exclude_front',
			array(
				'section'     => 'st_panel_post_area',
				'settings'    => 'st_main_setting_exclude_front',
				'label'       => 'トップページを除外する',
				'description' => '',
				'type'        => 'checkbox',
			) );

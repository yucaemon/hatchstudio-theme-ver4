...
if ( st_has_post_thumbnail() && (( isset($GLOBALS['stdata53']) && $GLOBALS['stdata53'] === 'yes' ) || ( isset( $eyecatchset ) && $eyecatchset === 'yes' ))) { ?>
	<div class="<?php st_eyecatch_class(); ?> <?php if(trim($GLOBALS['stdata217']) !== ''){ echo 'st-eyecatch-under'; } ?>">
		...
		if ( $youtube_thum_img ) {
			if ( ! $st_youtube_eyecatch && isset($GLOBALS['stdata241']) && $GLOBALS['stdata241'] === 'photo' ) {?>
			...
			if ( isset($GLOBALS['stdata241']) && $GLOBALS['stdata241'] === 'photo' ) {?>

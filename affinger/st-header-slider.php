...
if ( st_is_ver_ex() && ( get_the_date() != get_the_modified_date() ) && isset($GLOBALS['stdata592']) && $GLOBALS['stdata592'] === 'yes' ) :
...
$show_on_all_pages  = ( get_option( 'st-data18', '' ) === 'yes' );
$hide_on_mobile     = ( get_option( 'st-data71', '' ) === 'yes' );
$hide_header_images = ( get_option( 'st-data76', '' ) === 'yes' );

$nav_position = get_option( 'st-data35', '' );
$show_nav     = ( ! st_is_mobile() && $nav_position !== 'kesu' );

$show_slider = ( ! $hide_header_images && ( is_home() || is_front_page() || $show_on_all_pages ) && ( ! st_is_mobile() || ! $hide_on_mobile ) );
$show_header = ( $show_nav || $show_slider );
?>

<?php if ( $show_header ): ?>
	<div id="gazou-wide">
		<?php if ( $nav_position === '' ): ?>
			<?php get_template_part( 'st-header-menu' ); ?>
		<?php endif; ?>
					...
					<div id="st-header">
						<div class="header-post-slider-container">
							<div class="slider post-slider header-post-slider has-excerpt<?php echo esc_attr( $class ); ?>"
								...
								$no_img            = get_template_directory_uri() . '/images/no-img-l.png';
								$size              = 1060;
								?>
										...
										<div class="post-slide-body">
											<div class="post-slide-body-content">
												<div class="post-slide-text">
													...
													<?php if ( ! $hide_date ): ?>
														<?php if ( ! $show_published_date && $today_date ): ?>
															<p class="post-slide-date"><i class="st-fa st-svg-refresh"></i><?php echo esc_html( $today_date ); ?></p>
														<?php elseif ( ! $show_published_date && get_the_date() !== get_the_modified_date() ): ?>
